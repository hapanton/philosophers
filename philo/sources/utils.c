...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/28 00:45:40 by qsergean          #+#    #+#             */
/*   Updated: 2022/07/07 21:44:30 by qsergean         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_message(char *str, t_philo **philo)
{
	...
	pthread_mutex_lock(&(*philo)->data->new);
	if ((*philo)->data->n_died == 0)
	{
	...
	pthread_mutex_unlock(&(*philo)->data->new);
	pthread_mutex_unlock(&(*philo)->data->death);
